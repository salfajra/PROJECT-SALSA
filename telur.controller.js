...
exports.showDataTelur = async (request, response) => {
    try {
        ...
        /** send data to view */
        let sendData = { //object : make kurung
            page: `telur`,
            data: dataTelur,
 ...
 */
 ...
 exports.showEditPage = async (request, response) => {
    ...
    let selectedID = request.params.id //sesuai dengan route nya
    ...
    let sendData = {
        ...
        targetRoute: `/telur/edit/${selectedID}`, //ditampilin di view bagian action
        dataUser : request.session.dataUser
    }
